...
<body style="background-color: blue">
        ...
        <center><h2 style="background-color: white ">ENTER OLD PIN</h2></center>
        <center>
         <form action="SetPinServlet" method="post">
        <input type="number" name="pinNumber" class="input" required="required"  pattern="[0-9]{4}" title="Enter exactly 4 numbers"><br><br>
        </div>
        <div class="hi" >
